...
public class Node {
    ...
    Node(String name) {
        ...
        this.name = name;
        costToNeighborMap = new HashMap<>();
        messages = new HashMap<>();
        newMessages = false;
        messageQueue = new Vector<>();
        distanceVector = new HashMap<>();
        distanceVector.put(this, (float) 0.0);
     ...
     */
    private Collection<Node> getNeighbors() {
     ...
     */
    private Collection<Node> getDestinations() {
     ...
     *         specified destination
     */
    private Node getNextHopTo(Node destination) {
     ...
     *         distanceVector
     */
    private float getCostToDestination(Node destination) {
